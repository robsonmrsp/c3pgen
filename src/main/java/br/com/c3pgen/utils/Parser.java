...
public class Parser {
	...
	private static void applyBasicJsonValues(JsonAttribute jsonAttribute, Attribute attribute) {
		...
		jsonAttribute.setLenght(attribute.getLenght());
		jsonAttribute.setOffSet(attribute.getOffSet());
	...
	private static void applyBasicEntityValues(Attribute attribute, JsonAttribute jsonAttribute) {
		...
		attribute.setLenght(jsonAttribute.getLenght());
		attribute.setOffSet(jsonAttribute.getOffSet());
	...
	public static JsonModulo toJson(Modulo modulo) {
		...
		if (listItems != null) {
			for (ItemModulo loopItemModulo : listItems) {
				jsonModulo.getItems().add(toBasicJson2(loopItemModulo));
			}
		}
		return jsonModulo;
	}
