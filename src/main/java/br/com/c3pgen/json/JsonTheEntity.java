...
public class JsonTheEntity implements Serializable {
    ...
    private JsonAttribute firstStringAttribute;
    ...
    public void setFirstStringAttribute(JsonAttribute json) {
        firstStringAttribute = json;
    }

    public JsonAttribute getFirstStringAttribute() {
        return firstStringAttribute;
    }
}