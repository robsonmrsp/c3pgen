...
public class EntitiesGenerator {
	...
	private static MarkerGenerator jsMybatisPageGenerator;
	private static MarkerGenerator jsMybatisFormGenerator;
	private static MarkerGenerator jsMybatisModelGenerator;
	private static MarkerGenerator jsMybatisRouterGenerator;
	private static MarkerGenerator jsMybatisModalGenerator;
	private static MarkerGenerator JsMybatisMultiSelectGenerator;
	private static MarkerGenerator jsMybatisColelctionGenerator;
	private static MarkerGenerator jsMybatisPageColelctionGenerator;
	...
	public void generate(String... exceptions) throws Exception {
		...
		// "beans.tpl", webAppRootFolder + "WEB-INF/",
		// TemplateFileName.BEANS_XML, FileType.XML);
		...
		// JsMybatisMultiSelectGenerator = new MarkerGenerator(freeMarkerConfig,
		// application, "JsMybatisModalMultiSelectTemplate.tpl", jsRootFolder +
				...
				for (ApplicationEntity ent : application.getEntities()) {
					...
					if (notInException(ent.getName(), exceptions)) {
						...
						if (application.getPersistenceFramework().equals("hibernate")) {
							...
							rbacSeedGenerator.generateAppFragmentFile(application, application.getEntities());
							...
							// JsMybatisMultiSelectGenerator.generateEntityFile(application,
							// ent);
						...
						fragmentsGenerator.generateAppFragmentFile(application, application.getEntities());
