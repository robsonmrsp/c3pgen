...
//				+ File.separator + "rbac" + File.separator, "Role", FileType.JAVA));
    ...
    public static List<FSItemDescription> testResources(String rootResourcesFolder) {
        ...
        list.add(new FSItemDescription("application-test-containers", rootResourcesFolder, "application-test-containers", FileType.PROPERTIES));
...
//        list.add(new FSItemDescription("MD5ChecksumUtil", rootFolder + File.separator + "utils" + File.separator, "MD5ChecksumUtil", FileType.JAVA));
    ...
    public static List<FSItemDescription> otherConfig(String rootFolder) {
        List<FSItemDescription> list = new ArrayList<FSItemDescription>();

        list.add(new FSItemDescription("lombok", rootFolder + File.separator, "lombok", FileType.CONFIG));
        list.add(new FSItemDescription("docker-compose", rootFolder + File.separator  +"docker/", "docker-compose", FileType.YML));
