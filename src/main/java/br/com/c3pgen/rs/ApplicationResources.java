...
public class ApplicationResources {
	...
	public Response generate(@Context UriInfo uriInfo) {
		...
		try {
			...
			Application generateAppFromDataBase = applicationService.generateAppFromDataBase("jdbc:postgresql://localhost:5432/db_mercadodelivery", "postgres", "sints", "org.postgresql.Driver");
