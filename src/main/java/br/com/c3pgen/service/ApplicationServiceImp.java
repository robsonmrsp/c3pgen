...
import br.com.c3pgen.reverseengineering.crawler.DBImporterEntitiesFromFlatFileLayout;
...
public class ApplicationServiceImp implements ApplicationService {
	...
	public Application generateAppFromFlatFile() throws Exception {
		...
		return new DBImporterEntitiesFromFlatFileLayout().extractToApplication(null);
	}
}
