define(function(require) {
	...
	var PageControleCumbuca = require('views/controleCumbuca/PageControleCumbuca');
	var FormControleCumbuca = require('views/controleCumbuca/FormControleCumbuca');
	...
	var AppRouter = Backbone.Router.extend({
		routes : {
			...
			// hashs de ControleCumbuca
			'app/controleCumbucas' : 'controleCumbucas',
			'app/newControleCumbuca' : 'newControleCumbuca',
			'app/editControleCumbuca/:id' : 'editControleCumbuca',
			// hashs de Cor
			'app/cors' : 'cors',
			'app/newCor' : 'newCor',
		...
		//configuração das rotas de ControleCumbuca
		controleCumbucas: function() {
			util.markActiveItem('controleCumbucas');
			this.pageControleCumbuca = new PageControleCumbuca();
			this.App.mainRegion.show(this.pageControleCumbuca);
			util.breadcrumb({
				iconClass : 'fa-desktop',
				itemLabel : 'Controle Cumbuca',
				itemSubFolderName : 'Listagem',
				url : 'app/controleCumbucas'
			});
		},

		newControleCumbuca: function() {
			util.markActiveItem('controleCumbucas');
			var formControleCumbuca = new FormControleCumbuca({
				model : new ControleCumbucaModel(),
			});
			this.App.mainRegion.show(formControleCumbuca);
			util.breadcrumb({
				iconClass : 'fa-desktop',
				itemLabel : 'Controle Cumbuca',
				itemSubFolderName : 'Formulário de cadastro de Controle Cumbuca',
				url : 'app/controleCumbucas'
			});
		},
		
		editControleCumbuca: function(idControleCumbuca) {
			var that = this;
			util.markActiveItem('controleCumbucas');
			var formControleCumbuca = null;
			if (this.pageControleCumbuca) {
				formControleCumbuca = new FormControleCumbuca({
					model : this.pageControleCumbuca.controleCumbucas.get(idControleCumbuca),
				});
				that.App.mainRegion.show(formControleCumbuca);
			} else {
				var model = new ControleCumbucaModel({
					id : idControleCumbuca,
				})
				model.fetch({
					success : function(model) {
						formControleCumbuca = new FormControleCumbuca({
				...
				util.breadcrumb({
					iconClass : 'fa-calendar',
					itemLabel : 'ControleCumbucas',
					itemSubFolderName : 'Formulário de atualização de Controle Cumbuca',
					url : 'app/controleCumbucas'
				});
			}
		},
