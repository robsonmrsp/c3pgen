define(function(require) {
	...
	describe("Rotas", function() {
		...
		it("Rota de \"ControleCumbucas\"", function() {
			spyOn(Router.prototype, "ControleCumbucas")
			var router = new Router();
			Backbone.history.start();
			router.navigate('app/ControleCumbucas', true);
			expect(Router.prototype.ControleCumbucas).toHaveBeenCalled();
		});

		it("Rota de \"newcontroleCumbuca\"", function() {
			spyOn(Router.prototype, "newcontroleCumbuca")
			var router = new Router();
			Backbone.history.start();
			router.navigate('app/newcontroleCumbuca', true);
			expect(Router.prototype.newcontroleCumbuca).toHaveBeenCalled();
		});
		
		it("Rota de \"editcontroleCumbuca\"", function() {
			spyOn(Router.prototype, "editcontroleCumbuca")
			var router = new Router();
			Backbone.history.start();
			router.navigate('app/editcontroleCumbuca/1', true);
			expect(Router.prototype.editcontroleCumbuca).toHaveBeenCalled();
		});
