...
@Audited
@Table(name = "SACOLA")
@SequenceGenerator(name = "SACOLA_SEQUENCE", sequenceName = "SACOLA_SEQUENCE")
public class Sacola extends AbstractTimestampEntity{
	private static final long serialVersionUID = 1L;
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SACOLA_SEQUENCE")	
	private Integer id;
