...
@SequenceGenerator(name = "VARIEDADE_SEQUENCE", sequenceName = "VARIEDADE_SEQUENCE")
public class Variedade extends AbstractTimestampEntity{
	private static final long serialVersionUID = 1L;
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "VARIEDADE_SEQUENCE")	
	private Integer id;
