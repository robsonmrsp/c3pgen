...
@Audited
@Table(name = "COR")
@SequenceGenerator(name = "COR_SEQUENCE", sequenceName = "COR_SEQUENCE")
public class Cor extends AbstractTimestampEntity{
	private static final long serialVersionUID = 1L;
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "COR_SEQUENCE")	
	private Integer id;
