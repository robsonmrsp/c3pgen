...
public class Parser {
	...
	//converte de entidade para json --------------------
	private static JsonControleCumbuca toBasicJson(ControleCumbuca controleCumbuca) {
		JsonControleCumbuca jsonControleCumbuca = new JsonControleCumbuca();
		applyBasicJsonValues(jsonControleCumbuca, controleCumbuca);
		return jsonControleCumbuca;
	}
	
	private static ControleCumbuca toBasicEntity(JsonControleCumbuca jsonControleCumbuca) {
		ControleCumbuca controleCumbuca = new ControleCumbuca();
		applyBasicEntityValues(controleCumbuca, jsonControleCumbuca);
		return controleCumbuca;
	}
	
	private static void applyBasicJsonValues(JsonControleCumbuca jsonControleCumbuca, ControleCumbuca controleCumbuca) {
		jsonControleCumbuca.setId(controleCumbuca.getId());
		jsonControleCumbuca.setDataRegistro(DateUtil.localDateAsString(controleCumbuca.getDataRegistro()));
	    jsonControleCumbuca.setPeso(controleCumbuca.getPeso());
	    jsonControleCumbuca.setTipo(controleCumbuca.getTipo());
	    jsonControleCumbuca.setQuantidadeCachos(controleCumbuca.getQuantidadeCachos());
	}	
	private static void applyBasicEntityValues(ControleCumbuca controleCumbuca, JsonControleCumbuca jsonControleCumbuca) {
		controleCumbuca.setId(jsonControleCumbuca.getId());
	    controleCumbuca.setDataRegistro(DateUtil.stringAsLocalDate(jsonControleCumbuca.getDataRegistro()));
		controleCumbuca.setPeso(jsonControleCumbuca.getPeso());
		controleCumbuca.setTipo(jsonControleCumbuca.getTipo());
		controleCumbuca.setQuantidadeCachos(jsonControleCumbuca.getQuantidadeCachos());
	}	
	
	public static JsonControleCumbuca toJson(ControleCumbuca controleCumbuca) {
		JsonControleCumbuca jsonControleCumbuca = new JsonControleCumbuca();

		applyBasicJsonValues(jsonControleCumbuca, controleCumbuca);

		Cabine cabine_ = controleCumbuca.getCabine();
		if (cabine_ != null) {
			jsonControleCumbuca.setCabine(toJson(cabine_));
		}
		return jsonControleCumbuca;
	}


	public static ControleCumbuca apply(ControleCumbuca controleCumbuca, JsonControleCumbuca jsonControleCumbuca) {
	
		if(controleCumbuca ==  null)
			controleCumbuca = new ControleCumbuca();
		
		applyBasicEntityValues(controleCumbuca, jsonControleCumbuca) ;

		JsonCabine cabine_ = jsonControleCumbuca.getCabine();
		if (cabine_ != null) {
			controleCumbuca.setCabine(toEntity(cabine_));
		}	
		return controleCumbuca;
		
	}		
	public static ControleCumbuca toEntity(JsonControleCumbuca jsonControleCumbuca) {
		ControleCumbuca controleCumbuca = new ControleCumbuca();
		
		return apply(controleCumbuca, jsonControleCumbuca);
	}		
	
	public static List<JsonControleCumbuca> toListJsonControleCumbucas(List<ControleCumbuca> all) {
		List<JsonControleCumbuca> jsonControleCumbucas = new ArrayList<JsonControleCumbuca>();
		for (ControleCumbuca controleCumbuca : all) {
			jsonControleCumbucas.add(toJson(controleCumbuca));
		}
		return jsonControleCumbucas;
	}
	//converte de entidade para json --------------------
