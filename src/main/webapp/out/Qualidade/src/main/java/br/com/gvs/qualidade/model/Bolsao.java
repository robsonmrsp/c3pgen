...
@Audited
@Table(name = "BOLSAO")
@SequenceGenerator(name = "BOLSAO_SEQUENCE", sequenceName = "BOLSAO_SEQUENCE")
public class Bolsao extends AbstractTimestampEntity{
	private static final long serialVersionUID = 1L;
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "BOLSAO_SEQUENCE")	
	private Integer id;
		
	@Column(name = "NOME")
	private String nome;		
	
	@OneToMany(mappedBy="bolsao")
