...
public interface ${entity.name}Service {
	...
	List<${entity.name}> filter(Filter${entity.name} filter${entity.name}, Client owner, Boolean equals);
	
	List<${entity.name}> filter(PaginationParams paginationParams, Client owner, Boolean equals);
