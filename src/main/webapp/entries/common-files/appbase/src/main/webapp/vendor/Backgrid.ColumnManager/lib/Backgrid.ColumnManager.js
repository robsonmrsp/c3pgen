(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Backgrid.Extension.ColumnManager"] = factory(require("underscore"), require("jquery"), require("backbone"), require("backgrid"));
	else
		root["Backgrid.Extension.ColumnManager"] = factory(root["underscore"], root["jquery"], root["backbone"], root["backgrid"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Backgrid.Extension.ColumnManagerVisibilityControl = Backbone.View.extend({
	  ...
	  defaultOpts: {
	    ...
	    // Button
	    buttonTemplate: _.template("<a javascript:void() class='' data-toggle='tooltip' data-placement='top' title='' data-original-title='Exibir/Ocultar colunas' ><i class='fa fa-columns' aria-hidden='true'></i></a>"),
...
//	    if(this.options.closeOnClick)
	   ...
	   */
	  deferClose: function () {
		if(this.view.mouseOver) return false;
		this.view.trigger("dropdown:closed");
	...
	Backgrid.Extension.ColumnManager.ColumnVisibilityHeaderCell = Backgrid.HeaderCell.extend({
	  initialize: function (options) {
	    ...
	    this.$el.addClass("header-cell-manage-tool");
	  },
	  render: function () {
	    this.$el.empty();
