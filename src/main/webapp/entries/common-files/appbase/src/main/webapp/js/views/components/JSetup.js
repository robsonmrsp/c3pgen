define(function(require) {
	...
	//adaptado de https://github.com/cime/backgrid-expandable-cell
	var ExpandableCell = Backgrid.Cell.extend({
		className : "expand-col",
		accordion : true,
		toggle : '<i style="cursor: pointer;" class="glyphicon toggle "></i>',
		toggleClass : 'toggle',
