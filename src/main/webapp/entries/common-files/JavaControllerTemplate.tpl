...
public class ${entity.name}Controller {
	...
	public ResponseEntity get(@RequestParam MultiValueMap<String, String> mapParams) {
		...
		try {
			...
			JsonPaginator<Json${entity.name}> paginator = new JsonPaginator<Json${entity.name}>(Parser.toListJson${entity.name}(${firstLower(entity.name)}s.getItems()), ${firstLower(entity.name)}s.getActualPage(), ${firstLower(entity.name)}s.getTotalRecords());
