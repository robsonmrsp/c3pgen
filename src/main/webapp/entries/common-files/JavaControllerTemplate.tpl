...
public class ${entity.name}Controller {
	private final ${entity.name}Service ${firstLower(entity.name)}Service;
	<#if application.multitenancy == true && entity.multitenancy>

	private final SpringSecurityUserContext context;
	</#if>
	...
	public ResponseEntity get(@RequestParam MultiValueMap<String, String> mapParams) {
		...
		try {
			SearchParameters<Filter${entity.name}> paginationParams = new SearchParameters(mapParams, Filter${entity.name}.class);
