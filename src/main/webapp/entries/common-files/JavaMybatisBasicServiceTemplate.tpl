...
@Component
@Transactional
public class ${entity.name}Service extends SIGTAPService<${entity.name}, ${replaceAll(entity.name, 'SIGTAP','')}> {
	private static final Logger LOGGER = Logger.getLogger(${entity.name}Service.class);


	public ${entity.name}Service(Class<${replaceAll(entity.name, 'SIGTAP','')}> clazz) {
		super(clazz);
	}
	...
	@Override
	public ${entity.name} parse(${replaceAll(entity.name, 'SIGTAP','')} record) {
		${entity.name} sigtap = new ${entity.name}();
    
	<#if entity.attributes ??>		
	<#list entity.attributes as att>
	    sigtap.set${firstUpper(att.name)}(record.get${firstUpper(att.name)}());
	</#list>
	</#if >    
