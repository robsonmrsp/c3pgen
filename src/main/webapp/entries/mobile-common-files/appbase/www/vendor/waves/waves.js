...
(function(window, factory) {
	...
	/**
	 * Collection of wrapper for HTML element that only have single tag like
	 * <input> and <img>
	 */
	var TagWrapper = {
	...
	/**
	 * Hide the effect and remove the ripple. Must be a separate function to
	 * pass the JSLint...
	 */
		...
		if (element !== null) {
			...
			if (e.type === 'touchstart' && Effect.delay) {
				...
				var hideEffect = function(hideEvent) {
					...
					// if touch hasn't moved, and effect not yet started: start
					// effect now
					if (timer) {
						clearTimeout(timer);
						timer = null;
	 ...
	 * waves classes to a set of elements. Set drag to true if the ripple
	 * mouseover or skimming effect should be applied to the elements.
	 */
	...
	Waves.ripple = function(elements, options) {
		...
		options.position = options.position || null; // default = centre of
														// element
