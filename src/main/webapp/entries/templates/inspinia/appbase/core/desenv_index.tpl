...
<body class=" pace-done">
	...
	<div class="splash" id="loadInitialPanel" class="fader" style="position: absolute;    background-color: #676a6c; color: white;	fixed; text-align: center; height: 100%; width: 100%; top: 0; right: 0; left: 0; z-index: 99999999999; opacity: 0.99;">
		<div class="color-line"></div>
		<div class="splash-title">
			<h1>Aguarde, carregando...</h1>
			<img src="images/loading-bars-blank.svg" width="64" height="64">
		</div>
	</div>
	<div id="wrapper">
