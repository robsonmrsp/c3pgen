                            ...
                            <div className="row">
                                <div className="page-toolbar">
                                    <div className="col-sm-6">
	                                    <NavLink className="btn btn-info" to="/${firstLower(entity.name)}s/new">Novo Registro </NavLink>
									...
									<#list entity.basicSearches as basicAttr>
                						<div className="input-group">
                                            <input type="text" value={this.state.datatableConfig.filterParameters.${firstLower(basicAttr.name)}} className="form-control" placeholder="Pesquisar Filme por por ${firstUpper(basicAttr.displayName)}" />
