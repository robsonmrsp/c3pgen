					...
					<execution>
						...
						<configuration>
							...
							<cssSourceFiles>
								...
								<cssSourceFile>../vendor/theme/icons.css</cssSourceFile>
								<cssSourceFile>../vendor/theme/plugins.css</cssSourceFile>
								<cssSourceFile>../vendor/theme/main.css</cssSourceFile>
								<cssSourceFile>../vendor/theme/custom.css</cssSourceFile>
