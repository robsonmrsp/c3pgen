...
<body>
	...
	<div class="splash" id="loadInitialPanel" class="fader" style="   background: #75b9e6; position: fixed; text-align: center; height: 100%; width: 100%; top: 0; right: 0; left: 0; z-index: 99999999999; opacity: 0.99;">
		<div class="color-line"></div>
		<div class="splash-title" style="color: white;">
