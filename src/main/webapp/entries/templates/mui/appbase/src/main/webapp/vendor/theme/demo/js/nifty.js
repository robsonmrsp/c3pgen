 ...
 * -------------------------------------------------------------------------
 * 
 * OPTIONAL PLUGINS. You may choose whether to include it in your project or
 * not.
 * 
 * ========================================================================
 */
...
!function ($) {
    ...
    var defaults = {
        ...
        // VALUE : text-light || text-primary || text-info || text-success ||
		// text-warning || text-danger || text-mint || text-purple || text-pink
		// || text-dark
        // TYPE : String

        'iconClass'		: 'fa fa-refresh fa-spin fa-2x',
        // DESC : Class name of the font awesome icons", Currently we use
		// font-awesome for default value.
...
!function ($) {
    ...
    $.niftyNoty = function(options){
        var defaults = {
            ...
            // VALUE : primary || info || success || warning || danger || mint
			// || purple || pink || dark
            // TYPE : String
            ...
            container   : 'page',
            // DESC : This option is particularly useful in that it allows you
			// to position the notification.
            ...
            floating    : {
                position    : 'top-right',
                // Floating position.
                // Currently only supports "top-right". We will make further
				// development for the next version.
            ...
            html        : null,
            // Insert HTML into the notification. If false, jQuery's text method
            ...
            timer       : 0,
            // DESC : To enable the "auto close" alerts, please specify the time
			// to show the alert before it closed.
            ...
            onHidden    : function(){}
            // This event is fired when the notification has finished being
 ...
 * 
 * 
 * REQUIRE BOOTSTRAP DROPDOWNS http://getbootstrap.com/components/#dropdowns
 * ========================================================================
 */
 ...
 * 
 * OPTIONAL PLUGINS. You may choose whether to include it in your project or
 * not. Remove it if you don't use the Main Navigation.
 * ========================================================================
 * 
 * REQUIRE BOOTSTRAP POPOVER http://getbootstrap.com/javascript/#popovers
 * 
 * REQUIRE JQUERY RESIZEEND https://github.com/nielse63/jQuery-ResizeEnd
 * 
 * ========================================================================
 */
    ...
    var $menulink               = null,
                ...
                on('shown.bs.popover', function () {
                    ...
                    function(){
                        ...
                        $el.addClass('hover').popover('show').one('hidden.bs.popover', function () {
                            // detach from popover, fire event then clean up
							// data
        ...
        methods = {
            ...
            'bind' : function(){
                ...
                // =================================================================
//        		console.log('criando a animação do menu antest');
                try {
                	setTimeout(function() {
//                		console.log('criando a animação do menu');
