/* CustomerHistory´s Search Page generated by JSetup v0.95 :  at 2 de jun de 2023 19:04:24  */
...
const toFilterCustomerHistory = (values) => {
  return { 
    ...values,
  }
}
...
const columns = [
  ...
  },	
  {
    ...
    renderCell: (cellValues) => <ActionCell
      ...
      onEdit={(row) => {
        Router
          .push('/customerHistory/edit/' + row.id)
          .catch(console.error);
      }}
      onDelete={(row) => {
...
const Page = () => {
  ...
  const searchByFilter = () => {
    ...
    setFilter(toFilterCustomerHistory(values));
  }
          ...
          >
            <Stack direction="row" spacing={2}>
              ...
              <Button
                color="secondary"
                variant="contained"
                onClick={() => Router.push('/customerHistory/new').catch(console.error)}
              >
                Novo
              </Button>
            </Stack>
