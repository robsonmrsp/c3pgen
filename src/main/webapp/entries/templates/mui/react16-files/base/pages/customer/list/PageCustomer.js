/* Customer´s Search Page generated by JSetup v0.95 :  at 2 de jun de 2023 19:04:24  */
...
const Page = () => {
  ...
  const searchByFilter = () => {
    ...
    setFilter(toFilterCustomer(values));
  }
          ...
          >
            <Stack direction="row" spacing={2}>
              ...
              <Button
                color="secondary"
                variant="contained"
                onClick={() => Router.push('/customer/new').catch(console.error)}
              >
                Novo
              </Button>
            </Stack>
