...
const toFilterStatistics = (values) => {
  return { 
    ...values,
  }
}
...
const Page = () => {
  ...
  const searchByFilter = () => {
    ...
    setFilter(toFilterStatistics(values));
  }
          ...
          >
            <Stack direction="row" spacing={2}>
              ...
              <Button
                color="secondary"
                variant="contained"
                onClick={() => Router.push('/statistics/new').catch(console.error)}
              >
                Novo
              </Button>
            </Stack>
