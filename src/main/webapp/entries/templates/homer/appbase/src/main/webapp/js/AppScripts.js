define([ 'adapters/jquery-adapter' ], function($) {
	...
	var initialize = function() {
		...
		$(window).bind("resize click", function() {
			...
			// Waint until metsiMenu, collapse and other effect finish and set
			// wrapper
			// height
			setTimeout(function() {
				fixWrapperHeight();
		...
		function fixWrapperHeight() {
			...
			// Set new height when contnet height is less then navigation and
			// navigation
			// is less then window
			...
			// Set new height when contnet is higher then navigation but less
			// then
			// window
