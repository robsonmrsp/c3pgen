...
define(function(require) {
	...
	var FormTheEntitys = Marionette.LayoutView.extend({
		template : _.template(TemplateFormTheEntitys),
		...
		save : function(continua) {
			var that = this;
			var theEntity = that._getModel();

			if (this._isValid()) {
				theEntity.save({}, {
					success : function(_model, _resp, _options) {
						util.showMessage('success', 'TheEntity salvo com sucesso!');
						that.clearForm();

						if (continua != true) {
							util.goPage('app/theEntitys');
						}
					},
