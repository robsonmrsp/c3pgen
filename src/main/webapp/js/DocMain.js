...
require([ 'DocRouter', 'DocAppScripts', 'prism', 'plugins' ], function(DocRouter, DocAppScripts, prism, Plugins) {
	var router = new DocRouter();

	DocAppScripts.initialize();
