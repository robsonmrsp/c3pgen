...
define(function(require) {
	...
	joint.shapes.uml.Class = joint.shapes.basic.Generic.extend({
		...
		markup : [ '<g class="rotatable">', '<g class="scalable">', '<rect class="uml-class-name-rect"/><rect class="uml-class-attrs-rect"/><rect class="uml-class-methods-rect"/>', '</g>',
				'<text class="uml-class-name-text"/><text class="uml-class-attrs-text"/><text class="uml-class-methods-text"/>', '</g>' ].join(''),
	...
	joint.shapes.uml.State = joint.shapes.basic.Generic.extend({
		...
		updatePath : function() {
			...
			// We are using `silent: true` here because updatePath() is meant to
			// be
			// called
