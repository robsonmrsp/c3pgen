    ...
    VElement.prototype = {
        ...
        bbox: function(withoutTransformations, target) {
            ...
            try {
                ...
                // We are creating a new object as the standard says that you
				// can't
        ...
        text: function(content, opt) {
            ...
            for (var i = 0; i < lines.length; i++) {
                ...
                if (line) {
					...
					// dummy
                    // character and make it invisible, making the following
					// lines correctly
...
joint.dia.Graph = Backbone.Model.extend({
    ...
    cloneCells: function(cells) {
        ...
        // This is needed because when using a shallow clone (without `deep` set
		// to `true`),
    ...
    pointerup: function(evt, x, y) {
        ...
        if (this._action === 'label-move') {
            ...
            if (paperOptions.snapLinks) {
                ...
                // Finish off link snapping. Everything except view
				// unhighlighting was already done on pointermove.
                this._closestView && this._closestView.unhighlight(this._closestEnd.selector, { connecting: true, snapping: true });
                this._closestView = this._closestEnd = null;
