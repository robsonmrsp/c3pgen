		...
		<plugins>
			...
			<plugin>
				...
				<configuration>
					...
					<jsSrcDir>${r"${basedir}"}/src/main/webapp/js</jsSrcDir>

					<additionalContexts>
						<context>
							<contextRoot>vendor</contextRoot>
							<directory>${r"${basedir}"}/src/main/webapp/vendor</directory>
						</context>
						<context>
							<contextRoot>js</contextRoot>
							<directory>${r"${basedir}"}/src/main/webapp/js</directory>
						</context>
					</additionalContexts>

					<preloadSources>
						<source>vendor/require/require.js</source>
					</preloadSources>

					<customRunnerTemplate>src/main/webapp/SpecRunner.html</customRunnerTemplate>
				</configuration>
			</plugin>
			<plugin>
					...
					<execution>
						...
						<configuration>
							...
							<cssSourceFiles>
								...
								<cssSourceFile>../vendor/metisMenu/dist/metisMenu.css</cssSourceFile>
								<cssSourceFile>../vendor/animate.css/animate.css</cssSourceFile>
								<cssSourceFile>../vendor/theme/static_custom.css</cssSourceFile>
								<cssSourceFile>../vendor/pe-icon-7-stroke/css/pe-icon-7-stroke.css</cssSourceFile>
								<cssSourceFile>../vendor/pe-icon-7-stroke/css/helper.css</cssSourceFile>
								<cssSourceFile>../vendor/jquery.gritter-1.7.4/css/jquery.gritter.css</cssSourceFile>
								<cssSourceFile>../vendor/theme/style.css</cssSourceFile>
