...
define(function(require) {
	...
	var FormCbos = Marionette.LayoutView.extend({
		template : _.template(TemplateFormCbos),
		...
		save : function(continua) {
			var that = this;
			var cbo = that._getModel();

			if (this._isValid()) {
				cbo.save({}, {
					success : function(_model, _resp, _options) {
						util.showSuccessMessage('Cbo salvo com sucesso!');
						that.clearForm();

						if (continua != true) {
							util.goPage('app/cbos');
						}
					},
