...
define(function(require) {
	...
	var FormDepartamentos = Marionette.LayoutView.extend({
		template : _.template(TemplateFormDepartamentos),
		...
		save : function(continua) {
			var that = this;
			var departamento = that._getModel();

			if (this._isValid()) {
				departamento.save({}, {
					success : function(_model, _resp, _options) {
						util.showSuccessMessage('Departamento salvo com sucesso!');
						that.clearForm();

						if (continua != true) {
							util.goPage('app/departamentos');
						}
					},
