...
@Audited
@Table(name = "ANEXO")
@SequenceGenerator(name = "ANEXO_SEQUENCE", sequenceName = "ANEXO_SEQUENCE")
public class Anexo extends AbstractTimestampEntity{
	...
	@ManyToOne
	@JoinColumn(name = "ID_APONTAMENTOQUALIDADEPACKING")
	private ApontamentoQualidadePacking apontamentoQualidadePacking;		
	...
	public ApontamentoQualidadePacking getApontamentoQualidadePacking() {
		return apontamentoQualidadePacking;
	}
	
	public void setApontamentoQualidadePacking(ApontamentoQualidadePacking apontamentoQualidadePacking) {
